...
//useLocation works if in parent component providor is set. 
  ...
  const arrayofAllJsxMenuComponents: ((props: any) => JSX.Element)[] = [Start, Appointments, Refferals, Result, Receipts, Account, Login, SignIn ]
  const compsForNotLogged = [data.menu[0][0], data.menu[6][0], data.menu[7][0]];
  let ChosenChildcomp:(props: any) => JSX.Element = Start;
