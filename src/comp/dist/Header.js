...
require("./../App.css");
var ic_menu_png_1 = require("./../images/ic-menu.png");
var ic_logo_png_1 = require("./../images/ic-logo.png");
    ...
    return (react_1["default"].createElement("div", { className: "App-header" },
        react_1["default"].createElement("div", { className: "navbar-wrapper" },
            ...
            react_1["default"].createElement("div", { className: "menu-elements-wrapper", ref: wrapperRef }, ((windowWidth > 800) || ((windowWidth <= 800) && menuVisible)) &&
                (react_1["default"].createElement("div", { className: "menu-elements" }, newmenu.map(function (item) { return (react_1["default"].createElement(react_router_dom_1.BrowserRouter, null,
                    " ",
                    react_1["default"].createElement(react_router_dom_1.Link, { key: item[0], reloadDocument: true, to: "/" + item[1], className: "menu-a", key: item[0], onClick: changeMenuVisibility },
